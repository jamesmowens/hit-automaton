...
public class HybridCachingNestMegaSEQoperator extends SingleInputStreamOperator {
        ...
        public HybridCachingNestMegaSEQoperator(int operatorID, StreamQueue[] input,
                       StreamQueue[] output) {
