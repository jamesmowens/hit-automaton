...
public class PredicateCachingNestMegaSEQoperator extends SingleInputStreamOperator {
        ...
        public PredicateCachingNestMegaSEQoperator(int operatorID, StreamQueue[] input,
                       StreamQueue[] output) {
                           ...
                           if (childrenBuffers != null)
                             childrenBuffers.clear();
                                      for (int childIndex = 0; childIndex < children.size(); childIndex++) {
                                    	  ...
                                    	  double[] mintimestampl = new double[children.size()];
                                    	  double[] maxtimestampr = new double[children.size()];
                                          ...
                                          for (int i = this.cacheResults.get(qi)
                                        		  .getCache().size()-1 ; i >= processedNum; i--) {
                                        	  result = this.cacheResults.get(qi)
                                        	  .getCache().get(i);
                                          ...
                                          if (mintimestampl[childIndex]>timestampl)  
                                        	  mintimestampl[childIndex] = timestampl;
                                          
                                          if (maxtimestampr[childIndex]<timestampr)  {
                                        	  maxtimestampr[childIndex] = timestampr;
                                        	  mintimestampl[childIndex] = timestampl;
                                        	  result = this.cacheResults.get(qi)
                                        	  .getCache().get(i);
                                          }
...
//                                              exactMatch++;
                                              ...
                                              if (cacheResults.get(childID).righttime >= maxtimestampr[childIndex]) {
                                             	 ...
                                             	 partialMatch++;
                                                      ...
                                                      byte[] tu = Utility
                                                                     .binarySearch_rightbounds(
                                                                                     AIS[lastcIndex],
                                                                                     maxtimestampr[childIndex], inputschArray);
                                                      ...
                                                      // small adjustment.
                                                      // need debug binary search right bound
                                                      if (t > maxtimestampr[childIndex]) {// I give you another
                                                             // chance to see
                                                      ...
                                                      while (tu != null && t >= localtime
                                                                     && t <= maxtimestampr[childIndex]) {

                                                             tupleIndex = StreamAccessor
                                                                             .getIndex(tu);

                                                             tempchildBuffer = compute(childID, AIS,
                                                                             tu, inputschArray, mintimestampl[childIndex],
                                                                             maxtimestampr[childIndex]);
                                                             ...
                                                             t = StreamAccessor.getDoubleCol(tu,
                                                                             inputschArray, 1);
                                                             if (maxtimestampr[childIndex] > cacheResults.get(childID).righttime)
                         										cacheResults.get(childID).righttime = maxtimestampr[childIndex];
...
//                                                   
//                                                   }
//                                                   System.out.println(timestampl+ " " + timestampr);
//                                                   if(match)
//                                                  	 exactMatch++;
//                                                   else{
//                                                  	 partialMatch++;
