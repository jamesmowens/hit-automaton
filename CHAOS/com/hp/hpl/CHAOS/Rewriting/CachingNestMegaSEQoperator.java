...
public class CachingNestMegaSEQoperator extends SingleInputStreamOperator {
        ...
        public CachingNestMegaSEQoperator(int operatorID, StreamQueue[] input,
                       StreamQueue[] output) {
...
//                                              cacheResults.get(2).getCache().size() + " " + exactMatch + " " + partialMatch;
                               ...
                               try {
                                        FileWriter fstream = new FileWriter("Caching.txt", false);
        ...
        */
        ...
        protected ArrayList<ArrayList<byte[]>> compute(int qi,
               ...
               if (children.size() != 0) {
                       ...
                       long outerQueryStart = (new Date().getTime());
                       if (qiInfo.getOperatorType().equalsIgnoreCase("SEQ")){
                               produceinorder_HStacks(qi, stacks, tempevent, inputschArray,
                                              leftTimebound);
                               long outerQueryEnd = (new Date().getTime());
//                               System.out.print("Outer Query Time" +(outerQueryEnd-outerQueryStart));
                       }
...
//                                               System.out.println("outer results" + (this.cacheResults.get(qi)
//                                                       .getCache().size() - processedNum));
...
//                                                             exactMatch++;
                                              ...
                                              if (qi == 1) {
                                            	  ...
                                            	  long cacheMaintenanceEnd = (new Date()).getTime();
//                                                  Configure.totalChildren += cacheMaintenanceEnd
//                                                                 - totalChildrenStart;
//                                                  System.out.println("inner"+(execution_Start_child-cacheMaintenanceEnd));
