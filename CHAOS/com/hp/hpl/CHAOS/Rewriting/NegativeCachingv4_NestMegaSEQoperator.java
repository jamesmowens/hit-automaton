...
public class NegativeCachingv4_NestMegaSEQoperator extends SingleInputStreamOperator {
        ...
        public NegativeCachingv4_NestMegaSEQoperator(int operatorID, StreamQueue[] input,
                       StreamQueue[] output) {
                        ...
                        if(Configure.resultNum==52)
                         ...
                         System.out.println(write);
                               ...
                               */
                               ...
                               // .println(timestamp + " " + Configure.executionTime
                               // + " " + Configure.resultNum);
                       }
                                      ...
                                      for (int i = processedNum; i < this.cacheResults.get(qi)
                                              ...
                                              if (result.size() == 3) {
                                                     ...
                                                     timestampLast = StreamAccessor.getDoubleCol(
                                                      ...
                                                      if (timestampFirst == 34186.487 &&
                                                      timestampSecond == 34199.59 && timestampLast ==
                                                    	  34199.774) {
                                                             ...
                                                             if (childIndex == 0) {
                                                                     if (type == 0) {
                                                                            ...
                                                                            if (temp != null) {
                                                                             ...
                                                                             {
                                                                            	 double timestampleft = StreamAccessor.getDoubleCol(result.get(0),
                                                                            			 inputschArray, 1);
                                                                            	 double timestampright = StreamAccessor.getDoubleCol(result.get(1),
                                                                            			 inputschArray, 1);
                                                                             for(int it=0; it<bufferedTuple.size();it++ )
                                                                             {
                                                                             	temp = bufferedTuple.get(it); 
                                                                             	double tempright = StreamAccessor.getDoubleCol(temp.get(temp.size()-1),
                                                                           			 inputschArray, 1);
                                                                           	 double templeft = StreamAccessor.getDoubleCol(temp.get(0),
                                                                           			 inputschArray, 1);
//                                                                             	System.out.println(templeft+" "+ timestampleft);
//                                                                             	System.out.println(tempright+" "+timestampright);
                                                                             	if(templeft>timestampleft && tempright<timestampright)
                                                                             		stop = true;
                                                                             }
                                                                             }
