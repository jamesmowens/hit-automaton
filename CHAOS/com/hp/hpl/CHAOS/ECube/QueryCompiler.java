...
public class QueryCompiler {
	...
	public static ConceptTree createTreeCompany() {
		...
		ConceptBound rightCompany = new ConceptBound(17);
		...
		ConceptBound leftWPI = new ConceptBound(16); // create bounds for
		// AMAT
		ConceptBound rightWPI = new ConceptBound(16);
		ConceptBound[][] WPIBounds = new ConceptBound[2][1];
		WPIBounds[0][0] = leftWPI;
		WPIBounds[1][0] = rightWPI;

		ConceptNode WPI = new ConceptNode("WPI", 3, WPIBounds);// create
	...
	public static ConceptTree createTreePrice() {
		ConceptBound leftNumber = new ConceptBound(1); // create bounds for
														// number
		...
		ConceptNode number = new ConceptNode("Number", 1, numberBounds);// create
																		// number
																		// node
