...
public class SingleQAnormalDetectionOriginalOperator extends SingleInputStreamOperator {
	
	public SingleQAnormalDetectionOriginalOperator(int operatorID,
...
//System.out.println("Execution Start:" + execution_Start);
			...
			if (tuplesProcessed == 1) {
				...
				for (int j = 0; j < slideNumInWindow; j++) {
					...
					double slideEnd = slideStart + (double) slideLen;
