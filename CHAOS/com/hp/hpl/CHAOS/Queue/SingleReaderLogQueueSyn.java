...
public class SingleReaderLogQueueSyn extends SingleReaderQueueArrayImpSyn
		implements LogQueue {
	...
	public SingleReaderLogQueueSyn(SchemaElement[] schema) {
		super(schema);
		this.bw = null;
		this.logFileName = null;
	}

	public SingleReaderLogQueueSyn(SchemaElement[] schema, String logfilename) {
		super(schema);
		this.bw = null;
