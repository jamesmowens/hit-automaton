...
public class GElementFAStateRectangle extends GElementRectangle 
    ...
    public GElementFAStateRectangle() {
        setDraggable(true);
    }
    
    public GElementFAStateRectangle(GElementFAMachine machine) {
    	super(machine);
        setDraggable(true);
    }
	
    public GElementFAStateRectangle(State state, double x, double y,GElementFAMachine machine) {
    	super(machine);
        setState(state);
        setPosition(x, y);
        setDraggable(true);
