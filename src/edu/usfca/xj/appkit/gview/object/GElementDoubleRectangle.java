...
public abstract class GElementDoubleRectangle extends GElement implements XJXMLSerializable {
	public static final int DEFAULT_WIDTH = 100;
	public static final int DEFAULT_HEIGHT = 100;
	public static final int DEFAULT_WIDTH2 = 90;
	public static final int DEFAULT_HEIGHT2 = 90;

    protected double width = DEFAULT_WIDTH;
    protected double height = DEFAULT_HEIGHT;
    protected double width2 = DEFAULT_WIDTH2;
    protected double height2 = DEFAULT_HEIGHT2;
    ...
    public GElementDoubleRectangle() {
    }
    
    public GElementDoubleRectangle(GElementFAMachine machine) {
    	this.machine = machine;
    }
    ...
    public void updateAnchors() { // probably is wrong
        ...
        setAnchor(ANCHOR_TOP, position.add(new Vector2D(0, -(height/2))), Anchor2D.DIRECTION_TOP);
        setAnchor(ANCHOR_BOTTOM, position.add(new Vector2D(0, (height/2))), Anchor2D.DIRECTION_BOTTOM);
        setAnchor(ANCHOR_LEFT, position.add(new Vector2D(-(width/2), 0)), Anchor2D.DIRECTION_LEFT);
        setAnchor(ANCHOR_RIGHT, position.add(new Vector2D((width/2), 0)), Anchor2D.DIRECTION_RIGHT);
    }
